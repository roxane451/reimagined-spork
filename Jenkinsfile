        ...
        always {
            script {
                sh '''
                    ...
                    echo "Les déploiements Helm et ressources Kubernetes restent actifs"
                    echo "Pour vérifier l'état des déploiements, utilisez les commandes listées ci-dessous"
                '''
            }
        }
